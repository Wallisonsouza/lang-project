...
core::Symbol *Scope::declare(const std::u32string &name, core::SymbolKind kind, core::node::Node *declaration, core::Visibility visibility, bool is_builtin) {
...
core::Symbol *Scope::find(const std::u32string &name) {
...
void Scope::import_scope(const std::u32string &alias, Scope *scope) {
  if (!scope) return;
