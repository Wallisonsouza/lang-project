...
public:
  struct State {
    ...
    SourceRange range_to(const State &end) const { return SourceRange{.begin = {offset, line, column}, .end = {end.offset, end.line, end.column}}; }
  };
...
public:
  ...
  Span span_from(const State &a, const State &b) const { return Span{a.ptr, b.ptr}; }
