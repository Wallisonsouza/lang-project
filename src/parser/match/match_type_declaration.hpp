...
// inline core::node::Node *match_type_declaration(CompilationUnit &unit, utils::Stream<core::token::Token *> &stream) {

//   // auto keyword = stream.peek();
//   // if (!keyword || keyword->descriptor->kind != core::token::TokenKind::TypeKeyword) return nullptr;
...
//   //     if (!param || param->descriptor->kind != core::token::TokenKind::Identifier) break;
...
//   // return unit.ast.create_node<core::node::TypeDeclarationNode>(name, type_params);
//   return nullptr;
// }
