...
struct BlockStatementNode : core::node::StatementNode {
  ...
  explicit BlockStatementNode(
      std::vector<core::node::StatementNode *> stmts = {})
      : StatementNode(core::node::NodeKind::BlockStatement),
...
struct IfStatementNode : core::node::StatementNode {
  ...
  IfStatementNode(core::node::ExpressionNode *cond, BlockStatementNode *then_b,
                  BlockStatementNode *else_b = nullptr)
      : core::node::StatementNode(core::node::NodeKind::IfStatement),
        condition(cond), if_block(then_b), else_block(else_b) {}
};
...
struct FunctionDeclarationNode : core::node::StatementNode {
  ...
  FunctionDeclarationNode(core::node::IdentifierNode *identifier,
      ...
      : StatementNode(core::node::NodeKind::FunctionDeclaration),
        ...
        return_type(ret_type), body(b), modifiers(mods) {}
};

struct FunctionErrorNode : core::node::StatementNode {
  explicit FunctionErrorNode(const SourceSlice &slice = {})
...
struct IndexAccessNode : core::node::ExpressionNode {
  ...
  IndexAccessNode(core::node::ExpressionNode *b, core::node::ExpressionNode *i)
      : ExpressionNode(core::node::NodeKind::IndexAccess), base(b), index(i) {}
};
